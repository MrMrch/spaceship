...
// Example box object
var box = { x: 200, y: 200, size: 50, speed: 5 };
...
window.onload = function() {
    ...
    boxImage = new Image();
    boxImage.src = 'boxescolor.webp';

    playerImage = new Image();
    playerImage.src = 'spaceship.webp';

    powerUpImage = new Image();
    powerUpImage.src = 'powerUp.webp';
...
function checkCollisions() {
    ...
    for(let i = powerUps.length - 1; i >= 0; i--) {
        ...
        if(boundingBoxCollision(player, powerUp)) {
            bulletCount += 10; // Increase bullet count by 10
    ...
    for(let i = boxes.length - 1; i >= 0; i--) {
        ...
        for(let j = bullets.length - 1; j >= 0; j--) {
            ...
            if(boundingBoxCollision(bullet, box)) {
                ...
                score += 5; // Add score for destroying a box
                break;
            }
        }
    }
